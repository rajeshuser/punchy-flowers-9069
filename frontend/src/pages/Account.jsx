	...
	return (
		<div className="accountDiv">
			...
			<div style={{ padding: 80 }} className="devices">
				...
				<br />
				<p>
					Don't see your device here? To link a device or make changes, view your{" "}
					<a
						style={{
							textDecoration: "none",
							color: "rgb(96, 114, 249)",
				...
				<div style={{ display: "flex", gap: 20, padding: 30 }}>
					...
					/>
					<p>
						See the trade-in value of your device instantly. Trade it in for credit
						toward a new purchase, an Apple Store Gift Card or <br /> recycle it for
						free with Apple Trade in. <br />
						<a
							style={{
								textDecoration: "none",
								color: "rgb(96, 114, 249)",
